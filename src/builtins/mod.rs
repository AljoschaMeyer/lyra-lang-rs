...
//         map.insert(Id("to_string".to_string(), Meta::none()), Value::Fun(_Fun::Rust(to_string)));
//         map.insert(Id("typeof".to_string(), Meta::none()), Value::Fun(_Fun::Rust(type_of)));
//         map.insert(Id("and".to_string(), Meta::none()), Value::Fun(_Fun::Rust(and)));
//         map.insert(Id("or".to_string(), Meta::none()), Value::Fun(_Fun::Rust(or)));
//         map
//     };
// }
//
// fn to_string(args: Vector<Value>) -> Result<Value, Value> {
//     match args.front() {
